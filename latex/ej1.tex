...
\begin{itemize}
	...
	cuello de botella.
	\item Caminos atravezados: este grafo es el representado en la figura
	\ref{ej1:atravezados}. El propósito de esta prueba es chequear el correcto
